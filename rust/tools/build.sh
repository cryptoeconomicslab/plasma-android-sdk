...
OPENSSL_DIR=${PWD}/libs/arm64-v8a AR=${ndk_path}/arm64/bin/aarch64-linux-android-ar CC=${ndk_path}/arm64/bin/aarch64-linux-android-clang cargo build --target aarch64-linux-android --release
OPENSSL_DIR=${PWD}/libs/armeabi-v7a AR=${ndk_path}/arm/bin/arm-linux-androideabi-ar CC=${ndk_path}/arm/bin/arm-linux-androideabi-clang cargo build --target armv7-linux-androideabi --release
OPENSSL_DIR=${PWD}/libs/x86 AR=${ndk_path}/x86/bin/i686-linux-android-ar CC=${ndk_path}/x86/bin/i686-linux-android-clang cargo build --target i686-linux-android --release
